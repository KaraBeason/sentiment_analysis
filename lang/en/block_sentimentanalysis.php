...
$string['pluginname'] = 'Sentiment Analysis Task';
...
$string['tempfolderpath'] = 'Path to moodledata folder';
$string['tempfolderdesc'] = 'Please indicate the path to the moodledata folder.';